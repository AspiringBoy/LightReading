package com.dreamer_yy.lightreading.ui.personal;
...
public class PersonalFragment extends BaseFragment<NewsPresenter> implements NewsContract.View {
    ...
    public static PersonalFragment getInstance(){
        PersonalFragment newsFragment = new PersonalFragment();
